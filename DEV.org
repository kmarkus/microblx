...
* Next release (1.0)
** TODO update ubx_genblock to generate clean autotools modules
...
* release checklist
  ...
  - git tag
  - major version: update ubx<major>.pc.in
  - update code pkg-config checks in ubx_genblock configure.ac template
* archive
