...
local nd = ubx.node_create("data_errors_test", { loglevel = ffi.C.UBX_LOGLEVEL_WARN })

ubx.load_module(nd, "stdtypes")
ubx.load_module(nd, "testtypes")

--- Test data_set table beyond bounds without resize raises error
function test_data_set_beyond_bounds_no_resize()
...
function test_data_set_beyond_bounds_with_resize()
...
function test_data_set_scalar_to_array_no_resize()
...
function test_data_set_scalar_to_array_with_resize()
   local d = ubx.data_alloc(nd, "unsigned int", 3)
...
function test_data_alloc_unknown_type()
...
function test_data_set_struct_zero_len_resize()
...
function test_data_set_string_auto_resize()
