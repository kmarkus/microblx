...
int write_char_array(const ubx_port_t *p, const char *val, const long len);
int write_char(const ubx_port_t *p, const char *val);
long read_char_array(const ubx_port_t *p, char *val, const long len);
long read_char(const ubx_port_t *p, char *val);
long cfg_getptr_char(const ubx_block_t *b, const char *cfg_name, const char **valptr);
int write_int_array(const ubx_port_t *p, const int *val, const long len);
int write_int(const ubx_port_t *p, const int *val);
long read_int_array(const ubx_port_t *p, int *val, const long len);
long read_int(const ubx_port_t *p, int *val);
long cfg_getptr_int(const ubx_block_t *b, const char *cfg_name, const int **valptr);
int write_uint_array(const ubx_port_t *p, const unsigned int *val, const long len);
int write_uint(const ubx_port_t *p, const unsigned int *val);
long read_uint_array(const ubx_port_t *p, unsigned int *val, const long len);
...
int write_long_array(const ubx_port_t *p, const long *val, const long len);
int write_long(const ubx_port_t *p, const long *val);
long read_long_array(const ubx_port_t *p, long *val, const long len);
long read_long(const ubx_port_t *p, long *val);
long cfg_getptr_long(const ubx_block_t *b, const char *cfg_name, const long **valptr);
int write_ulong_array(const ubx_port_t *p, const unsigned long *val, const long len);
int write_ulong(const ubx_port_t *p, const unsigned long *val);
long read_ulong_array(const ubx_port_t *p, unsigned long *val, const long len);
...
int write_uint8_array(const ubx_port_t *p, const uint8_t *val, const long len);
int write_uint8(const ubx_port_t *p, const uint8_t *val);
long read_uint8_array(const ubx_port_t *p, uint8_t *val, const long len);
...
int write_uint16_array(const ubx_port_t *p, const uint16_t *val, const long len);
int write_uint16(const ubx_port_t *p, const uint16_t *val);
long read_uint16_array(const ubx_port_t *p, uint16_t *val, const long len);
...
int write_uint32_array(const ubx_port_t *p, const uint32_t *val, const long len);
int write_uint32(const ubx_port_t *p, const uint32_t *val);
long read_uint32_array(const ubx_port_t *p, uint32_t *val, const long len);
...
int write_uint64_array(const ubx_port_t *p, const uint64_t *val, const long len);
int write_uint64(const ubx_port_t *p, const uint64_t *val);
long read_uint64_array(const ubx_port_t *p, uint64_t *val, const long len);
...
int write_int8_array(const ubx_port_t *p, const int8_t *val, const long len);
int write_int8(const ubx_port_t *p, const int8_t *val);
long read_int8_array(const ubx_port_t *p, int8_t *val, const long len);
...
int write_int16_array(const ubx_port_t *p, const int16_t *val, const long len);
int write_int16(const ubx_port_t *p, const int16_t *val);
long read_int16_array(const ubx_port_t *p, int16_t *val, const long len);
...
int write_int32_array(const ubx_port_t *p, const int32_t *val, const long len);
int write_int32(const ubx_port_t *p, const int32_t *val);
long read_int32_array(const ubx_port_t *p, int32_t *val, const long len);
...
int write_int64_array(const ubx_port_t *p, const int64_t *val, const long len);
int write_int64(const ubx_port_t *p, const int64_t *val);
long read_int64_array(const ubx_port_t *p, int64_t *val, const long len);
...
int write_size_t_array(const ubx_port_t *p, const size_t *val, const long len);
int write_size_t(const ubx_port_t *p, const size_t *val);
long read_size_t_array(const ubx_port_t *p, size_t *val, const long len);
...
int write_float_array(const ubx_port_t *p, const float *val, const long len);
int write_float(const ubx_port_t *p, const float *val);
long read_float_array(const ubx_port_t *p, float *val, const long len);
...
int write_double_array(const ubx_port_t *p, const double *val, const long len);
int write_double(const ubx_port_t *p, const double *val);
long read_double_array(const ubx_port_t *p, double *val, const long len);
