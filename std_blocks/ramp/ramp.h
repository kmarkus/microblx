/*
 * ramp microblx function block (autogenerated, don't edit)
 */
...
ubx_port_t ramp_ports[] = {
	{ .name="out", .out_type_name="double", .out_data_len=1, .doc="ramp generator output"  },
	{ NULL },
};
...
def_write_fun(write_out, double)
